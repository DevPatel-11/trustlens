...
const AdminDashboard = () => {
  ...
  const tabs = [
    ...
    { id: 'analytics', name: 'TrustDNA' },
    { id: 'product-tracker', name: 'Product Tracker' },
    { id: 'review-auth', name: 'Review Auth' },
    { id: 'marketplace', name: 'Marketplace' },
    { id: 'predictions', name: 'Prediction Market' },
    { id: 'alerts', name: 'Alert System' },
